                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Accueille</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="user-id">Nome Et Prenome</label>
                                    <input type="text" name="name" class="form-control" placeholder="Nome et prenome">
                                </div>                
                                
                                <div class="form-group">
                                    <label for="phone">Numero de telephone</label>
                                    <input type="number" name="phone"  class="form-control" placeholder="Numero de telephone" maxlength="10">
                                </div>

                                <div class="form-group">
                                    <label for="about-me">Votre Commentaire</label>
                                    <textarea class="form-control" name="content" rows="7" placeholder="Enter Texte de commentaire"></textarea>
                                </div>
                                <input type="submit" class="btn btn-info mb-4" name="insert" value="Envoyez Commetaire">
                            </div>
							</form>
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> <img src="admin/user/<?php echo $row['6'];?>" alt="userimage">
                                    ...
                                    <div class="font-18">
                                        <div class="mb-1 text-capitalize"><b>Nome:</b> <?php echo $row['1'];?></div>
