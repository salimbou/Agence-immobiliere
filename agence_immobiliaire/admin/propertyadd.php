            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Immobilier</h3>
								<ul class="breadcrumb">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Add Detaills De L'immobilier</h4>
								</div>
								<form method="post" enctype="multipart/form-data">
								<div class="card-body">
									<h5 class="card-title">Details Immobilier</h5>
									<?php echo $error; ?>
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="title" required placeholder="Entrer Titre">
													</div>
												</div>
												<div class="form-group row">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="price" required placeholder="Enter Prix">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Étage totale</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required placeholder="Enter Surface (en metre carree)">
													</div>
												</div>
												<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
													...
													<div class="col-md-4">
														...
														<li class="mb-3"><span class="text-secondary font-weight-bold">Vidéosurveillance : </span>Yes</li>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Utilisateurid</label>
													<div class="col-lg-9">
